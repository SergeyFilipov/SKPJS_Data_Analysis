...
**Description:**  
Filtering observations with triggered alarm conditions and labeling them by severity. Numeric thresholds are applied to identify abnormal sensor readings.  
...
## 📦 R Libraries Used  
`tidyverse`, `caret`, `xgboost`, `randomForest`, `rpart`, `glmnet`, `nnet`,  
`pROC`, `DiagrammeR`, `PRROC`, `lubridate`, `forcats`, `broom`  
...
into a local isolated library, ensuring that the analysis runs identically everywhere.
...
Predictive Modelling of Alarm Events in Railway Rolling Stock Systems

🔥 This project demonstrates a complete end-to-end data analysis workflow —
from raw railway system data to interpretable machine learning models for predictive maintenance.
